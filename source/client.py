...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, trainloader, vallodaer, num_classes, classes_channels, classes_class) -> None:
        super().__init__()
...
def generate_client_fn(trainloaders, valloaders, num_classes, classes_channels, classes_class):
    ...
    def client_fn(cid: str):
        ...
        return FlowerClient(
            ...
            classes_channels=classes_channels,
            classes_class = classes_class
        )
